...
mymainmenu = awful.menu({
    items = {
        {"awesome", myawesomemenu, beautiful.widget_awesome},
        {"app", myappmenu},
...
-- calendar
lain.widgets.calendar:attach(mytextclock, {cal='/usr/bin/cal -h', font='DejaVu Sans Mono', font_size = 10 })
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "w",
        function ()
            myawesomemenu:show({ keygrabber = true })
        end),
